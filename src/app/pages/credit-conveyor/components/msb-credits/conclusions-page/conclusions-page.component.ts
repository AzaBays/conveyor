    ...
    <div class="w-100 h-100 d-flex flex-column">
      <div class="application">
        <div class="application-content mr-2" (scroll)="onScroll($event)">
          ...
          <!--                    </progress-bar>-->
          <!--                  </div>-->
          <!--                  <div class="card-header-action-btn">-->
          <!--                    &lt;!&ndash;                    (click)="openDialog(item, i)"&ndash;&gt;-->
...
export class ConclusionsPageComponent implements OnInit {
